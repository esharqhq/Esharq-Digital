...
export const Showcase = ({ dict }: { dict: any }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-[2.8rem] sm:text-7xl md:text-9xl font-black tracking-tighter leading-[0.9] sm:leading-[0.85] uppercase mb-4 sm:mb-6">
          <span
            className="text-[#C8ECED] block"
            style={{ textShadow: '0 0 30px rgba(39, 223, 233, 0.4)' }}
          >
            {dict.titleLine1} <br />
            {dict.titleLine2} <br />
            {dict.titleLine3}
        ...
        <p className="text-base sm:text-xl md:text-2xl text-[#C8ECED]/60 font-medium tracking-wide mb-8 sm:mb-10 max-w-2xl mx-auto italic">
          {dict.subtitle}{' '}
          <span className="text-[#27DFE9] font-black underline decoration-1 underline-offset-8">
            {dict.subtitleHighlight}
          </span>
          .
        </p>
